...
//------------------------------------------------------------------------------
/**
 * \struct fpos_t_arduino_arduino_arduino_arduino_arduino
 * \brief internal type for istream
 * do not use in user apps
 */
struct fpos_t_arduino{
  /** stream position */
  uint32_t position;
  /** cluster for position */
  uint32_t cluster;
  fpos_t_arduino() : position(0), cluster(0) {}
};
...
class SdBaseFile {
 public:
   ...
   */
  void getpos(fpos_t_arduino* pos);
  /** set position for streams
   * \param[out] pos struct with value for new position
   */
  void setpos(fpos_t_arduino* pos);
  //----------------------------------------------------------------------------
  bool close();
