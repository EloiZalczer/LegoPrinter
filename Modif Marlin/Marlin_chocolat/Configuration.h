...
//********CHOCOLATE PRINTING*********
//***********************************
//To permenantly disable chocolate printing settings and functions, comment the next line
#define CHOCO

//if the user enables : chocolate_mode = 1 ; default = 0.
#ifdef CHOCO
...
#define STRING_VERSION_CONFIG_H __DATE__ "31/01/2016 " __TIME__ // build date and time
...
// Displayed in the LCD "Ready" message
 #define CUSTOM_MACHINE_NAME "Lego"
...
#ifndef CHOCO //If you print chocolate, the Marlin doesn"t controle extrusion
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {40,40,4000,830}  // default steps per unit for Ultimaker
